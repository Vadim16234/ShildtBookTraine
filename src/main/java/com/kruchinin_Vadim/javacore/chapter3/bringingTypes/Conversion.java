...
значение byte.
    ...
    Как работает деление по модулю: d(323) % b(256) - сколько раз значение 256 помещается в 323? 1 раз
следовательно 323 - 256 = 67
Другой пример:
17 % 5 как это выглядит:
17 - 5 = 12
12 - 5 = 7
7 - 5 = 2 - итоговое значение
 */
